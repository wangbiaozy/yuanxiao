...
$(function () {
    ...
    (function(){
        for(var i = 0; i < friendRecordInfo.length; i++){
            str += '<li><img src="'+friendRecordInfo.friendPhoto+'"><p><span>'+friendRecordInfo.friendName+'</span><span>'+friendRecordInfo.percent+'</span></p><p>'+friendRecordInfo.score+'</p></li>';
        }
