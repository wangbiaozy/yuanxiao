...
$(function () {
    ...
    (function(){
        ...
        for(var i = 0; i < friendRecordInfo.length; i++){
            str += '<li><img src="'+friendRecordInfo[i].friendPhoto+'"><p><span>'+friendRecordInfo[i].friendName+'</span><span class="_percent">'+friendRecordInfo[i].percent+'</span></p><p class="_score">'+friendRecordInfo[i].score+'</p><a href="javascript:void(0)"></a><i class="'+_myLanType+'"></i class="'+_friendLanType+'"><i></i></li>';
        }
