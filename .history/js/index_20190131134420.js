...
$(function () {
    ...
    var imgLink = "http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTLBa8a3aKZ2KNnRFmstgTKeuOT3SZSwVFk7d7k37MCDGSyegicfeVFGbzDNFtPa3XiaqxvWhfPsM87A/132";
    ...
    $('#make-btn').on('click',function(){
        if($('#pic').children().hasClass('box'),{allowTaint: false}){
