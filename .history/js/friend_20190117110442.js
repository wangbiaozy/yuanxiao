...
$(function () {
    ...
    (function(){
        ...
        for(var i = 0; i < friendRecordInfo.length; i++){
            str += '<li><img src="'+friendRecordInfo[i].friendPhoto+'"><p><span>'+friendRecordInfo[i].friendName+'</span><span class="_percent">'+friendRecordInfo[i].percent+'</span></p><p class="_score">'+friendRecordInfo[i].score+'</p><a href="javascript:void(0)"></a><i id="mlt" class="'+friendRecordInfo[i].myLanType+'"></i><i id="flt" class="'+friendRecordInfo[i].friendLanType+'"></i></li>';
        }
    ...
    $('#record-list li').on('click','a',function(){
        ...
        $('.look-my-hd').attr('src',$this.siblings('i#mlt').attr('class'));
        $('.look-friend').attr('src',$this.siblings('i#flt').attr('class'));
