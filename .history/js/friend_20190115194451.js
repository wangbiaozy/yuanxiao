...
$(function () {
    ...
    //好友花灯类型
    var friendNum = Math.floor(Math.random() * 9) + 1;//好友抽取的随机数  此处从后台拿
    var friendLanType = $('.friend').attr('src').subString()
    

    //好友入口弹窗
    (function(){
        $('.hd-name').text(lanternsName[lanternsNum-1]);
        $('.friend').attr("src",imgPath + "r_" + lanternsNum + ".png");//此处路径取好友花灯图片路径
