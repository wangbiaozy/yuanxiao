...
$(function () {
    ...
    (function(){
        ...
        for(var i = 0; i < friendRecordInfo.length; i++){
            str += '<li><img src="'+friendRecordInfo[i].friendPhoto+'"><p><span>'+friendRecordInfo[i].friendName+'</span><span>'+friendRecordInfo[i].percent+'</span></p><p>'+friendRecordInfo[i].score+'</p><a href="javascript:void(0)"></a></li>';
        }
